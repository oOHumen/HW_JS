...
// function getUsersByDate(arr) {
//     let filtered = arr.filter(element => element.registrationDate === "09.10.2021" || element.registrationDate === "10.10.2021");
//     console.log(filtered);
// }
// getUsersByDate(users);
...
function getUniqueName(arr) {
    let namesFromArr = arr.map(el => el.name);
    console.log(Array.from(new Set(namesFromArr)));
}
getUniqueName(taskTwoJson);
*/
...
// const jsonTaskTwo = require("./task2.json");
// console.log(jsonTaskTwo);
